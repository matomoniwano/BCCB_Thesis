...
# color scheme
color_EEC <- c("blue", "orange", "blue", "green", "blue", "orange", "orange", "red", "green", "purple", "purple", "green", "purple", "purple", "green", "green", "red", "red", "green", "purple", "red", "red", "green", "orange", "blue", "blue", "green", "orange")
labels_colors(p.hclust_EEC) <- color_EEC 

# plot
plot(p.hclust_EEC, hang = -1, cex.lab = 4, cex.axis = 0.8)
...
NMDS_new_EEC <- ggplot(data.scores_EEC, aes(x = NMDS1, y= NMDS2)) + 
  geom_point(size = 7, aes( shape = season, color = as.factor(year))) + # Choosing mapping for the plot
  theme(axis.text.y = element_text(colour = "black", size = 12, face = "bold"), # Text formatting
    ...
    labs(x = "NMDS1", color = "Collection Date", y = "NMDS2", shape = "season") # Label formatting
...
sample_data(Ps_EEC_hellinger)$collection_date <- as.factor(date_EEC)
...
RDA_EEC <- plot_ordination(Ps_EEC_hellinger, rda_EEC, type = "sample", color="collection_date", shape = "season")
...
RDA_EEC + 
  ...
  theme(axis.text.y = element_text(colour = "black", size = 12, face = "bold"), # Text formatting
    ...
    legend.key=element_blank()) + 
    labs(color = "Date") # Label formatting
...
#by dates
plot_ordination(Ps_EEC_hellinger, Ps_MDS_EEC, color = "collection_date", shape = "season") +
  geom_point(size = 4) + # Choosing mapping for the plot 
  theme(axis.text.y = element_text(colour = "black", size = 12, face = "bold"), # Text formatting
    axis.text.x = element_text(colour = "black", face = "bold", size = 12), # axis text formatting
    legend.text = element_text(size = 12, face ="bold", colour ="black"), # legend text formatting
