...
data.scores_peakpoc$collection_date_end = sample_info_tab_peakpoc$collection_date_end
...
NMDS_new_peakpoc <- ggplot(data.scores_peakpoc, aes(x = NMDS1, y= NMDS2)) + 
  geom_point(size = 4, aes( shape = season, color = collection_date_end)) + # Choosing mapping for the plot
